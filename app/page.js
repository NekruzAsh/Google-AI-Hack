        ...
        >
          <Grid item xs={4}>
            ...
            >
              ...
              <button onClick={handleRedirectEmail} className="btn bg-indigo-800 text-white w-10/12">
                Continue with email
              </button>
              <button onClick={manuallyLogin} className="bg-gray-600 text-white btn w-10/12">
                Manually login
              </button>
